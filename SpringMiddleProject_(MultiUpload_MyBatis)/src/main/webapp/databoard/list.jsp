  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <table class="table table-hover">
        ...
        <tr>
          <th width=5% class="text-center">${vo.no }</th>
          <th width=45% class="text-center"><a href="detail.do?no=${vo.no}">${vo.subject }</a></th>
          ...
          <th width=10% class="text-center">
            <c:if test="${filecount>0 }">
              <img src="note.png" style="width:20px;height:20px">
            </c:if>
          </th>
        </tr>
        </c:forEach>
