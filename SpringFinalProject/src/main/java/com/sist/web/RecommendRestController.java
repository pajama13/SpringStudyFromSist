...
import com.sist.dao.*;
import com.sist.vo.*;
import com.sist.recommend.*;
@RestController
public class RecommendRestController {
	@Autowired
	private NaverRecommendData nrd;
    ...
    @GetMapping(value="food/recommend_change.do",produces = "text/plain;charset=UTF-8")
    public String recommend_change(int no)
    {
    	String[] strArr=null;
    	if(no==1)
    	{
    ...
    @GetMapping(value="food/recommend_result.do",produces = "text/plain;charset=UTF-8")
    public String recommend_result(String ss)
    {
